...
import solo.sololand.util.Sphere;

public class IslandGenerator extends Generator {

	public static final int TYPE_ISLAND = 10;
	...
	public void generateChunk(int chunkX, int chunkZ){
		...
		for (int z = 0; z < 16; z++){
			...
			chunk.setBlock(x, 4, z, Block.STONE);
			chunk.setBlock(x, 5, z, Block.STONE);
			chunk.setBlock(x, 6, z, Block.STONE);
			chunk.setBlock(x, 7, z, Block.SAND);
			chunk.setBlock(x, 8, z, Block.STILL_WATER);
			chunk.setBlock(x, 9, z, Block.STILL_WATER);
